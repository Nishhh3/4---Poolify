...
if stype=='Dry Skin':
    ...
    def oproducts():
     ...
     import dbv
    login_button=tk.Button(result_window,text="Go to Home",font=('Times new roman',20),bd=0,bg='darkseagreen4',fg='white',activebackground='darkolivegreen',activeforeground='white',width=20,command=oproducts)
    ...
    def oproducts():
     ...
     try:
        ...
        messagebox.showerror("Error",f"Could not open dbv.py:\n{e}")
    login_button=tk.Button(result_window,text="Go to Home",font=('Times new roman',20),bd=0,bg='darkseagreen4',fg='white',activebackground='pink2',activeforeground='white',width=10,command=oproducts)
    login_button.place(x=900,y=590)
    ...
    def oproducts():
     result_window.destroy()
     import dbv
    login_button=tk.Button(result_window,text="Go to Home",font=('Times new roman',28),bd=0,bg='darkseagreen4',fg='white',activebackground='pink2',activeforeground='white',width=8,command=oproducts)
    login_button.place(x=900,y=590)
