...
class SkincareApp:
    def __init__(self, root):
        ...
        ttk.Button(sidebar, text="Home Remedies", command=self.on_home_remedies_click).pack(pady=5, padx=10, fill=tk.X)
    ...
    def on_home_remedies_click(self):
        subprocess.run(["python", "hr2.py"])  # Opens hr2.py in a new process
