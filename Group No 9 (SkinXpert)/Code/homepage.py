...
def dash():
     ...
     try:
        ...
        messagebox.showerror("Error",f"Could not open dbv.py:\n{e}")  # Import and run dashboard.py (this will launch the dash)
...
# Button to view pro
view_products = tk.Button(hp, text="Go to Home", font=("Times New Roman", 26), bg="darkseagreen4", fg="white", command=dash)
