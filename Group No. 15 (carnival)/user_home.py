...
eve_list =["BGMI","VALORANT","HOUSEFULL","CHESS","CARROM"]
...
if eve_list:
    ...
    print("eve_list is empty, cannot access elements")
...
image = ctk.CTkImage(Image.open("title.jpeg"), size=(500, 400))
image_lbl = ctk.CTkLabel(TitleCard, image=image, text="")  # Empty text to show only image
image_lbl.place(relx=0.5, y=0, anchor="n")  # Centers horizontally, sticks to the top
