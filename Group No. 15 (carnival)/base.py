...
carnival_label = ctk.CTkLabel(carnival_frame, text="GATHEREASE", font=("Times", 80,'italic'),text_color='#FF3399', bg_color='#fac6c6', fg_color='#fac6c6')
